...
public class Departamentos extends javax.swing.JInternalFrame {
     ...
     * @param v
     */
    public Departamentos(variables v) {
        initComponents();
        this.v = v;
        inicia();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "INSERT INTO departamentos (Departameto) VALUES ('" + jTextField1.getText().toUpperCase().trim() + "')";
        try {
        ...
        jList1.setModel(v.carga_lista(1));
